    ...
    <div class="card mx-auto">
        ...
        <div class="card-header">
            ...
            <!-- Button trigger modal -->
                    <button wire:click="showCountryModal" class="btn btn-primary">New Country</button>
            </div>
            </div>
        </div>
        <div class="card-body">
            <table class="table" wire:loading.remove>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $country->Name }}</td>
                        <td>
                            <button wire:click="showEditModal({{ $country->id }})" class="btn btn-success">Edit</a>
                            <button wire:click="deletecountry({{ $country->id }})" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                        @empty
                        <tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        @if($editMode)
            <button type="button" class="btn btn-primary" wire:click="updateCountry" >Udpate country</button>
        @else
